...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Quoridor - moteur Python (CLI console).")
    parser.add_argument(
        "--difficulty",
        choices=["facile", "normal", "difficile"],
        help="Niveau de l'IA (sinon demande interactive).",
    )
    parser.add_argument(
        "--debug",
        action="store_true",
...
def main():
    """Point d'entrée CLI : lance le mode console."""
