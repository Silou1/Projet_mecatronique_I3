...
//
// Cablage (mapping breadboard 2026-05-20, recupere les GPIO L298N de M1) :
//   - STEP -> GPIO 14
//   - DIR  -> GPIO 27
//   - EN   -> GPIO 26  (actif LOW : LOW = driver actif, HIGH = desactive)
...
//     Monter a 0.5V si perte de pas, max 0.75V pour NEMA17 standard.
//
...
static constexpr uint8_t PIN_EN   = 26;
...
void setup() {
  ...
  Serial.println("STEP=GPIO 14, DIR=GPIO 27, EN=GPIO 26 (actif LOW)");
